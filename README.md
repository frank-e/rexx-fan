...
2. **rexxsort**: cf. [manual](https://web.archive.org/web/20110813004357/http://omniplex.om.funpic.de/rexxsort.htm) on WayBack. The `KWIK` in [ygrep.rex](../master/ygrep.rex) etc. is a copy of the *treble QSort* here.
