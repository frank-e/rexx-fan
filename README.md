...
2. **[pi](https://github.com/frank-e/rexx-fan/blob/master/pi.rex "pi.rex")**: Comparison of 42 Pi algorithms (was [pi.cmd](https://web.archive.org/web/20020719190406/http://frank.ellermann.bei.t-online.de:80/src/pi.cmd "Pi.cmd") in 2002). 
